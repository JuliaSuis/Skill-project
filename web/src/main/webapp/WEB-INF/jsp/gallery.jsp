...
<head>
    ...
    <title>Album example for theorems</title>
...
<main role="main">
    ...
    <section class="jumbotron text-center">
        <div class="container">
            <h1 class="jumbotron-heading">Album of matematicians</h1>
            <p class="lead text-muted">Make it short, just keywords</p>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        ...
                        <div class="card-body">
                            <p class="card-text">This is a preview card with supporting text below</p>
